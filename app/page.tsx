...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {!isLoggedIn && (
        <>
      {/* Why Predelivery.ai? Section - Logo blue background, white text */}
      <div id="benefits" className="relative bg-gradient-to-b from-[#0040FF] via-[#0033CC] to-[#0040FF] py-24 sm:py-32 scroll-mt-20 overflow-hidden">
        {/* Pattern overlay */}
        <div className="absolute inset-0 opacity-10" style={{backgroundImage: 'repeating-linear-gradient(45deg, transparent, transparent 50px, rgba(255,255,255,0.15) 50px, rgba(255,255,255,0.15) 100px)'}}></div>
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <div className="inline-block mb-6">
                <span className="text-white font-bold text-sm uppercase tracking-wider px-4 py-2 bg-white/20 rounded-full border border-white/30">Why Choose Us</span>
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="group relative bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 hover:border-white/40 transition-all duration-300 hover:scale-105 hover:shadow-2xl overflow-hidden">
                <div className="absolute top-0 right-0 w-32 h-32 bg-[#0040FF]/20 rounded-full blur-3xl"></div>
                <div className="relative z-10">
                  <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-[#0040FF] to-[#0033CC] flex items-center justify-center mb-6 shadow-lg group-hover:scale-110 transition-transform duration-300">
                    <AlertTriangle className="w-7 h-7 text-white" strokeWidth={2.5} />
                  </div>
                  <h3 className="text-xl font-bold mb-3 text-white">Reduce post-delivery disputes</h3>
                  <p className="text-white/80 text-sm leading-relaxed">Document everything before handover to prevent costly disputes.</p>
                </div>
              </div>

              <div className="group relative bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 hover:border-white/40 transition-all duration-300 hover:scale-105 hover:shadow-2xl overflow-hidden">
                <div className="absolute top-0 right-0 w-32 h-32 bg-[#FF7F00]/20 rounded-full blur-3xl"></div>
                <div className="relative z-10">
                  <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-[#FF7F00] to-[#E66A00] flex items-center justify-center mb-6 shadow-lg group-hover:scale-110 transition-transform duration-300">
                    <ShieldCheck className="w-7 h-7 text-white" strokeWidth={2.5} />
                  </div>
                  <h3 className="text-xl font-bold mb-3 text-white">Protect warranty claims</h3>
                  <p className="text-white/80 text-sm leading-relaxed">Create verifiable records that support warranty and insurance claims.</p>
                </div>
              </div>
              ...
              <div className="group relative bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 hover:border-white/40 transition-all duration-300 hover:scale-105 hover:shadow-2xl overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-xl font-bold mb-3 text-white">Create a defensible delivery record</h3>
                  <p className="text-white/80 text-sm leading-relaxed">Build comprehensive digital records that stand up in any dispute.</p>
                </div>
              </div>
              ...
              <div className="group relative bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 hover:border-white/40 transition-all duration-300 hover:scale-105 hover:shadow-2xl overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-xl font-bold mb-3 text-white">Prevent post registration risks</h3>
                  <p className="text-white/80 text-sm leading-relaxed">Identify and resolve issues before vehicle registration and delivery.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* How it works Section - Blue background, white text */}
      <div id="how-it-works" className="relative bg-gradient-to-b from-[#0040FF] via-[#0033CC] to-[#0040FF] py-24 sm:py-32 scroll-mt-20 overflow-hidden">
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <div className="inline-block mb-6">
                <span className="text-white font-bold text-sm uppercase tracking-wider px-4 py-2 bg-white/20 rounded-full border border-white/30">Simple Process</span>
              </div>
              <h2 className="text-4xl sm:text-5xl md:text-6xl font-extrabold mb-6 text-white">
                How it works
              </h2>
              <div className="max-w-4xl mx-auto mb-12">
                <p className="text-lg sm:text-xl text-white/90 leading-relaxed">
                  Start with a <span className="font-semibold text-white">comprehensive inspection</span>, then <span className="font-semibold text-[#FFB366]">verify all vehicle details</span> with digital documentation, <span className="font-semibold text-[#FFB366]">obtain approval</span> through digital signatures, and finally <span className="font-semibold text-white">deliver with confidence</span> knowing every detail is recorded and verified.
                </p>
              </div>
            </div>

            <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 lg:gap-6">
              <div className="group relative bg-white/10 backdrop-blur-sm rounded-2xl p-8 border-2 border-white/20 hover:border-white/40 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                <div className="absolute -top-6 left-1/2 -translate-x-1/2 lg:left-6 lg:translate-x-0 w-14 h-14 bg-gradient-to-br from-[#0040FF] to-[#0033CC] text-white rounded-full flex items-center justify-center font-extrabold text-xl shadow-2xl z-30 group-hover:scale-110 transition-all duration-300 border-4 border-[#0040FF]">
                  1
                </div>
                <div className="relative z-10 pt-6 flex flex-col items-center">
                  <div className="w-20 h-20 rounded-xl bg-gradient-to-br from-[#0040FF] to-[#0033CC] flex items-center justify-center mb-6 shadow-xl group-hover:scale-110 transition-transform duration-300">
                    <ClipboardCheck className="w-10 h-10 text-white" strokeWidth={2.5} />
                  </div>
                  <h3 className="text-xl font-bold mb-4 text-white text-center">Inspect</h3>
              ...
              <div className="group relative bg-white/10 backdrop-blur-sm rounded-2xl p-8 border-2 border-white/20 hover:border-white/40 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                <div className="absolute -top-6 left-1/2 -translate-x-1/2 lg:left-6 lg:translate-x-0 w-14 h-14 bg-gradient-to-br from-[#FF7F00] to-[#E66A00] text-white rounded-full flex items-center justify-center font-extrabold text-xl shadow-2xl z-30 group-hover:scale-110 transition-all duration-300 border-4 border-[#FF7F00]">
                  2
                </div>
                <div className="relative z-10 pt-6 flex flex-col items-center">
                  <div className="w-20 h-20 rounded-xl bg-gradient-to-br from-[#FF7F00] to-[#E66A00] flex items-center justify-center mb-6 shadow-xl group-hover:scale-110 transition-transform duration-300">
                    <Check className="w-10 h-10 text-white" strokeWidth={3} />
                  </div>
                  <h3 className="text-xl font-bold mb-4 text-white text-center">Verify</h3>
                  <p className="text-white/80 text-center leading-relaxed text-sm">
              ...
              <div className="group relative bg-white/10 backdrop-blur-sm rounded-2xl p-8 border-2 border-white/20 hover:border-white/40 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                ...
                <div className="relative z-10 pt-6 flex flex-col items-center">
                  ...
                  <h3 className="text-xl font-bold mb-4 text-white text-center">Sign Off</h3>
                  <p className="text-white/80 text-center leading-relaxed text-sm">
              ...
              <div className="group relative bg-white/10 backdrop-blur-sm rounded-2xl p-8 border-2 border-white/20 hover:border-white/40 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                ...
                <div className="relative z-10 pt-6 flex flex-col items-center">
                  ...
                  <h3 className="text-xl font-bold mb-4 text-white text-center">Deliver</h3>
                  <p className="text-white/80 text-center leading-relaxed text-sm">
      ...
      {/* Powerful Features Section - Blue background, white text */}
      <div id="features" className="relative bg-gradient-to-b from-[#0033CC] via-[#0040FF] to-[#0033CC] py-24 sm:py-32 scroll-mt-20 overflow-hidden">
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <div className="inline-block mb-6">
                <span className="text-white font-bold text-sm uppercase tracking-wider px-4 py-2 bg-white/20 rounded-full border border-white/30">Core Features</span>
              </div>
              <h2 className="text-4xl sm:text-5xl md:text-6xl font-extrabold mb-6 text-white">
                Powerful Features
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
              <div className="group relative bg-[#0040FF] rounded-xl overflow-hidden border-2 border-white transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                <div className="relative h-56 overflow-hidden">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#0040FF] via-[#0040FF]/20 to-transparent"></div>
                  <div className="absolute top-4 left-4 px-3 py-1 bg-[#0040FF] text-white text-xs font-bold rounded-full">Photo Gallery</div>
                </div>
                <div className="p-6 bg-[#0040FF]">
                  <h3 className="text-xl font-bold mb-3 text-white">Photo Gallery</h3>
                  <p className="text-white leading-relaxed text-sm">Capture and organize inspection photos with GPS metadata and timestamps</p>
                </div>
              </div>
              ...
              <div className="group relative bg-[#0040FF] rounded-xl overflow-hidden border-2 border-white transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                ...
                <div className="p-6 bg-[#0040FF]">
                  <h3 className="text-xl font-bold mb-3 text-white">Vehicle Identity Capture</h3>
                  <p className="text-white leading-relaxed text-sm">Digitally extract VIN and compliance information from vehicle labels to create a verified pre-delivery record</p>
                </div>
              </div>
              ...
              <div className="group relative bg-[#0040FF] rounded-xl overflow-hidden border-2 border-white transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                <div className="relative h-56 overflow-hidden">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#0040FF] via-[#0040FF]/20 to-transparent"></div>
                  <div className="absolute top-4 left-4 px-3 py-1 bg-[#0040FF] text-white text-xs font-bold rounded-full">GPS Tracking</div>
                </div>
                <div className="p-6 bg-[#0040FF]">
                  <h3 className="text-xl font-bold mb-3 text-white">GPS Tracking</h3>
                  <p className="text-white leading-relaxed text-sm">Automatic location tracking for all inspection photos and activities</p>
                </div>
              </div>
              ...
              <div className="group relative bg-[#0040FF] rounded-xl overflow-hidden border-2 border-white transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                <div className="relative h-56 overflow-hidden">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#0040FF] via-[#0040FF]/20 to-transparent"></div>
                  <div className="absolute top-4 left-4 px-3 py-1 bg-[#0040FF] text-white text-xs font-bold rounded-full">Analytics</div>
                </div>
                <div className="p-6 bg-[#0040FF]">
                  <h3 className="text-xl font-bold mb-3 text-white">Analytics Dashboard</h3>
                  <p className="text-white leading-relaxed text-sm">Track inspection metrics and generate comprehensive reports</p>
                </div>
              </div>
              ...
              <div className="group relative bg-[#0040FF] rounded-xl overflow-hidden border-2 border-white transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                ...
                <div className="p-6 bg-[#0040FF]">
                  ...
                  <p className="text-white leading-relaxed text-sm">Bank-level security with audit trails and compliance records</p>
                </div>
              </div>
              ...
              <div className="group relative bg-[#0040FF] rounded-xl overflow-hidden border-2 border-white transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                <div className="relative h-56 overflow-hidden">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#0040FF] via-[#0040FF]/20 to-transparent"></div>
                  <div className="absolute top-4 left-4 px-3 py-1 bg-[#0040FF] text-white text-xs font-bold rounded-full">Efficiency</div>
                </div>
                <div className="p-6 bg-[#0040FF]">
                  <h3 className="text-xl font-bold mb-3 text-white">Fast & Efficient</h3>
                  <p className="text-white leading-relaxed text-sm">Streamlined workflow reduces inspection time by up to 60%</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Who It's For? Section - Logo orange background, white text */}
      <div className="relative bg-gradient-to-b from-[#FF7F00] via-[#E66A00] to-[#FF7F00] py-24 sm:py-32 scroll-mt-20 overflow-hidden">
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <div className="inline-block mb-6">
                <span className="text-white font-bold text-sm uppercase tracking-wider px-4 py-2 bg-white/20 rounded-full border border-white/30">Target Audience</span>
              </div>
              <h2 className="text-4xl sm:text-5xl md:text-6xl font-extrabold mb-6 text-white">
                Who It's For?
              </h2>
            ...
            {/* Who It's For Grid - images visible, solid blue theme */}
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="group relative bg-[#0040FF] rounded-xl overflow-hidden border-2 border-white transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                <div className="relative h-56 overflow-hidden">
                  <Image
                    ...
                    className="object-cover group-hover:scale-110 transition-transform duration-300"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#0040FF] via-[#0040FF]/30 to-transparent"></div>
                  <div className="absolute top-4 left-4 px-3 py-1 bg-[#0040FF] text-white text-xs font-bold rounded-full">Dealerships</div>
                </div>
                <div className="p-6 bg-[#0040FF]">
                  <h3 className="text-xl font-bold mb-3 text-white">Dealerships</h3>
                  <p className="text-white leading-relaxed text-sm">Reduce post-delivery disputes and protect handover quality.</p>
                </div>
              </div>
              ...
              <div className="group relative bg-[#0040FF] rounded-xl overflow-hidden border-2 border-white transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                <div className="relative h-56 overflow-hidden">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#0040FF] via-[#0040FF]/30 to-transparent"></div>
                  <div className="absolute top-4 left-4 px-3 py-1 bg-[#0040FF] text-white text-xs font-bold rounded-full">Fleet & Leasing</div>
                </div>
                <div className="p-6 bg-[#0040FF]">
                  <h3 className="text-xl font-bold mb-3 text-white">Fleet & Leasing Companies</h3>
                  <p className="text-white leading-relaxed text-sm">Standardise vehicle delivery across locations and suppliers.</p>
                </div>
              </div>
              ...
              <div className="group relative bg-[#0040FF] rounded-xl overflow-hidden border-2 border-white transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                ...
                <div className="p-6 bg-[#0040FF]">
                  <h3 className="text-xl font-bold mb-3 text-white">OEM & Delivery Partners</h3>
                  <p className="text-white leading-relaxed text-sm">Enforce consistent pre-delivery inspection standards at scale.</p>
                </div>
              </div>
              ...
              <div className="group relative bg-[#0040FF] rounded-xl overflow-hidden border-2 border-white transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                <div className="relative h-56 overflow-hidden">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#0040FF] via-[#0040FF]/30 to-transparent"></div>
                  <div className="absolute top-4 left-4 px-3 py-1 bg-[#0040FF] text-white text-xs font-bold rounded-full">Insurance</div>
                </div>
                <div className="p-6 bg-[#0040FF]">
                  <h3 className="text-xl font-bold mb-3 text-white">Insurers & Financiers</h3>
                  <p className="text-white leading-relaxed text-sm">Access verified condition records that stand up in claims and disputes.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Compliance and Trust Section - Blue background, white text */}
      <div className="relative bg-gradient-to-b from-[#0040FF] via-[#0033CC] to-[#0040FF] py-24 sm:py-32 overflow-hidden">
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <div className="inline-block mb-6">
                <span className="text-white font-bold text-sm uppercase tracking-wider px-4 py-2 bg-white/20 rounded-full border border-white/30">Trust & Security</span>
              </div>
              <h2 className="text-4xl sm:text-5xl md:text-6xl font-extrabold mb-6 text-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border-2 border-white/20 hover:border-white/40 shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105">
                <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-[#0040FF] to-[#0033CC] flex items-center justify-center mb-6 shadow-lg">
                  <Shield className="w-8 h-8 text-white" strokeWidth={2.5} />
                </div>
                <h3 className="text-lg font-bold mb-3 text-white">Enterprise-grade data security</h3>
                <p className="text-white/80 text-sm">Bank-level encryption and security protocols</p>
              </div>

              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border-2 border-white/20 hover:border-white/40 shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105">
                <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-[#FF7F00] to-[#E66A00] flex items-center justify-center mb-6 shadow-lg">
                  <Lock className="w-8 h-8 text-white" strokeWidth={2.5} />
                </div>
                <h3 className="text-lg font-bold mb-3 text-white">Role-based access controls</h3>
                <p className="text-white/80 text-sm">Granular permissions and access management</p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border-2 border-white/20 hover:border-white/40 shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105">
                ...
                <h3 className="text-lg font-bold mb-3 text-white">Audit trails, analytics and inspection history</h3>
                <p className="text-white/80 text-sm">Complete transparency and traceability</p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border-2 border-white/20 hover:border-white/40 shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105">
                ...
                <h3 className="text-lg font-bold mb-3 text-white">Built by automotive experts</h3>
                <p className="text-white/80 text-sm">Deep inspection and automotive data experience</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Pricing Section - Logo blue background, white text */}
      <div className="relative bg-gradient-to-b from-[#0033CC] via-[#0040FF] to-[#0033CC] py-24 sm:py-32 overflow-hidden">
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <div className="inline-block mb-6">
                <span className="text-white font-bold text-sm uppercase tracking-wider px-4 py-2 bg-white/20 rounded-full border border-white/30">Flexible Pricing</span>
              </div>
              <h2 className="text-4xl sm:text-5xl md:text-6xl font-extrabold mb-6 text-white">
                Pricing
              </h2>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-10 md:p-14 border-2 border-white/20 shadow-2xl hover:border-white/40 transition-all duration-300">
              <div className="text-center space-y-6">
                <div className="w-20 h-20 rounded-xl bg-gradient-to-br from-[#FF7F00] to-[#E66A00] flex items-center justify-center mx-auto mb-6 shadow-xl">
                ...
                <div className="pt-6">
                  <Link href="/contact" className="inline-flex items-center gap-2 px-8 py-4 bg-[#FF7F00] hover:bg-[#E66A00] text-white font-bold rounded-lg shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300 border border-white/30">
